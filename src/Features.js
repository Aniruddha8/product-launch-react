...
function Features(props){
    return(
            <div id={props.linkId}>
                <div className="feature animate__animated animate__slideInLeft">
                ...
                <div className="feature animate__animated animate__slideInRight">
                    <svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-gear-wide" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="feature animate__animated animate__slideInLeft">
                    ...
                    <p>Our cunstomers are satisfied around the globe.</p>
                </div>
            </div>
    )
}
